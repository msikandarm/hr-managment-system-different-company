...
class LeaveTypeTable extends DataTableComponent
{
    public function columns(): array
    {
        return [
            Column::make(__('Title'), 'title')
                ->searchable()
                ->sortable(),
            Column::make(__('Days Allowed'), 'days_allowed')
                ->sortable(),
            ...
            Column::make(__('Action'))
                ->label(
                    fn ($row) => view('admin.leave-types.actions')->withRow($row)
                ),
        ];
    }
    ...
    public function configure(): void
    {
        $this->setPrimaryKey('id')
            ...
            ->setThAttributes(function (Column $column) {
                ...
                if ($column->isField('days_allowed')) {
                    return [
                        'width' => '150px',
                    ];
                }
